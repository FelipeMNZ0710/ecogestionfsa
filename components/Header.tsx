...
const Header: React.FC<HeaderProps> = ({ currentPage, setCurrentPage, user, setUser, unreadCount }) => {
  ...
  const handleLogout = () => {
      ...
      setIsMenuOpen(false);
      setIsProfileMenuOpen(false);
      if (currentPage === 'perfil' || currentPage === 'admin' || currentPage === 'notificaciones' || currentPage === 'canjear') {
          setCurrentPage('home');
      }
  }
                        ...
                        <div className="relative" ref={profileMenuRef}>
                            ...
                            {isProfileMenuOpen && (
                                <div className="profile-menu-dropdown">
                                    ...
                                    <div className="py-1">
                                        <a href="#" onClick={(e) => { e.preventDefault(); handleNavClick('perfil'); }} className="profile-menu-item flex items-center gap-3">
                                         ...
                                         <a href="#" onClick={(e) => { e.preventDefault(); handleNavClick('canjear'); }} className="profile-menu-item flex items-center gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v2a2 2 0 01-2 2H7a2 2 0 01-2-2V4zm11.25 4.75a.75.75 0 000-1.5H15V4a.75.75 0 00-1.5 0v1.25H11a.75.75 0 000 1.5h2.5V11a.75.75 0 001.5 0V8.75H17a.75.75 0 00.75-.75zM5 12a2 2 0 012-2h6a2 2 0 012 2v2a2 2 0 01-2 2H7a2 2 0 01-2-2v-2z" /></svg>
                                            Canjear Ecopuntos
                                        </a>
                                        <a href="#" onClick={(e) => { e.preventDefault(); handleNavClick('notificaciones'); }} className="profile-menu-item flex items-center gap-3 relative">
                                            ...
                                            Notificaciones
                                            {unreadCount > 0 && <span className="absolute right-3 top-1/2 -translate-y-1/2 w-2 h-2 bg-red-500 rounded-full"></span>}
                                        </a>
                                    </div>
                                    <div className="py-1 border-t border-white/10">
                                        <button onClick={handleLogout} className="profile-menu-item text-red-400 w-full text-left flex items-center gap-3">
