...
interface FindTheIntruderGameProps {
    onComplete: (score: number) => void;
    userHighScore: number;
}

const FindTheIntruderGame: React.FC<FindTheIntruderGameProps> = ({ onComplete, userHighScore }) => {
    useEffect(() => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-3xl font-bold text-text-main">Encuentra el Intruso</h2>
...
export default FindTheIntruderGame;