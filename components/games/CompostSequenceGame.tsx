...
interface CompostSequenceGameProps {
    onComplete: (score: number) => void;
    userHighScore: number;
}

const CompostSequenceGame: React.FC<CompostSequenceGameProps> = ({ onComplete, userHighScore }) => {
    useEffect(() => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-3xl font-bold text-text-main">Secuencia de Compost</h2>
...
export default CompostSequenceGame;