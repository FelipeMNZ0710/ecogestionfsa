...
interface EcoWordleGameProps {
    onComplete: (score: number) => void;
    userHighScore: number;
}

const EcoWordleGame: React.FC<EcoWordleGameProps> = ({ onComplete, userHighScore }) => {
    useEffect(() => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-3xl font-bold text-text-main">Palabra Secreta</h2>
