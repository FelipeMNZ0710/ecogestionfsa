...
interface MythBustersGameProps {
    onComplete: (score: number) => void;
    userHighScore: number;
}

const MythBustersGame: React.FC<MythBustersGameProps> = ({ onComplete, userHighScore }) => {
    useEffect(() => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-3xl font-bold text-text-main">¿Mito o Realidad?</h2>
...
export default MythBustersGame;