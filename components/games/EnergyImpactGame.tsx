...
interface EnergyImpactGameProps {
    onComplete: (score: number) => void;
    userHighScore: number;
}

const EnergyImpactGame: React.FC<EnergyImpactGameProps> = ({ onComplete, userHighScore }) => {
    useEffect(() => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center text-center flex-col">
            ...
            <h2 className="text-3xl font-bold text-text-main">Impacto Energético</h2>
...
export default EnergyImpactGame;